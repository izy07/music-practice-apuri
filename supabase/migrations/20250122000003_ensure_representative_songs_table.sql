...
-- すべての必要なカラムとデータを含む包括的なマイグレーション

-- 1. representative_songsテーブルの作成（存在しない場合のみ）
...
BEGIN
  ...
  -- バイオリンの代表曲を挿入（重複チェック付き - タイトルと作曲者の組み合わせで判定）
