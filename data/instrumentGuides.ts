export const instrumentGuides = {
    violin: {
      ...
      basicTerms: {
        ...
        string: '弦：G線、D線、A線、E線の4本の弦。それぞれ異なる音程と音色を持ちます。'
      },
      fingering: {
      ...
      roadmap: {
        weeks: [
          { title: 'Week 1: 姿勢と弓の基本', items: ['正しい姿勢を身につける（立ち姿勢、肩当ての調整）', '弓を弦に対して垂直に上下に動かす練習'] },
          { title: 'Week 2: 音階と指の位置', items: ['ドレミファソラシドの音階を練習する', '指を置く位置を正確に覚える'] },
          { title: 'Week 3: メロディーに挑戦', items: ['簡単なメロディーを演奏してみる'] },
          { title: 'Week 4: 高音域への拡張', items: ['高い音域のドレミファソラシドにも挑戦する'] },
        ]
      }
    },
    piano: {
    ...
    viola: {
      ...
      basicTerms: {
        ...
        bowHair: '弓毛：弓に張られた馬の毛。松脂を塗って弦を擦り、音を出します。',
        rosin: '松脂：弓毛に塗る樹脂。弓毛と弦の摩擦を高めて音を出します。',
        string: '弦：C線、G線、D線、A線の4本の弦。それぞれ異なる音程と音色を持ちます。'
      },
      tuning: {
    ...
    contrabass: {
      ...
      basicTerms: {
        ...
        bowHair: '弓毛：弓に張られた馬の毛。松脂を塗って弦を擦り、音を出します。',
        rosin: '松脂：弓毛に塗る樹脂。弓毛と弦の摩擦を高めて音を出します。',
        string: '弦：E線、A線、D線、G線の4本の弦。それぞれ異なる音程と音色を持ちます。'
      },
      tuning: {
    ...
    other: {
      ...
      roadmap: {
        weeks: [
          { title: 'Week 1: 基礎', items: ['楽器の持ち方', '基本姿勢', '音の出し方'] },
          { title: 'Week 2: 基本練習', items: ['基礎練習', '簡単なメロディ', 'リズム練習'] },
          { title: 'Week 3: 応用', items: ['応用練習', '表現の練習', 'テクニックの向上'] },
          { title: 'Week 4: 総合', items: ['総合練習', '録音して確認', '次の目標設定'] }
        ]
      }
    }
};
